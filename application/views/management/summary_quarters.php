...
<div class="panel panel-primary" ng-controller="GradeCtrl">
  <div class="panel-heading">&nbsp;</div>
  <div class="panel-body">

	<ul class="nav nav-tabs" id="module_ul">
	  <li class="active" id="student_grade"><a href="javascript:void(0);" onclick="grade_process('module_tabs','student_grade')">STUDENTS GRADES</a></li>
	 
	  <li class="" id="student_ranking"><a href="javascript:void(0);" onclick="grade_process('module_tabs','student_ranking')">SUBJECT RANKING <span id="subject_here"></span></a></li>
	...
	<br>
		...
		<div id="final_list">
							...
							<tr>
								<td valign="top" width="25%">
									<div class="input-group" style="padding-right:10px;">
										...
										<select style="width:140px;" onChange="grade_process('find_sections','')" id="selected_subject" class="form-control btn btn-primary" title="Please select subject">
								...
								<td valign="top" width="25%">
									<div class="input-group" style="padding-right:10px;">
										...
										<select style="width:140px;" id="selected_section" onChange="grade_process('find_years',this)" disabled="disabled" class="form-control btn btn-primary" title="Please select section">
								...
								<div style="padding-right:10px;">
									<button class="btn btn-md btn-primary" disabled="disabled" id="selected_btn" onClick="grade_process('find_records','')" style="height:35px;"><i class="fa fa-paper-plane"></i> Select</button>
									&nbsp;&nbsp;
								</div>
			...
			<div class="col-md-3">
				...
				<button class="btn btn-md btn-success" disabled="disabled" id="btn_print" onClick="grade_process('print_record','')" style="height:55px; "><i class="fa fa-print fa-lg"></i> Print <br> Summary of Quarterly Grade</button>
				&nbsp;
			</div>
			<br>
			<br>
